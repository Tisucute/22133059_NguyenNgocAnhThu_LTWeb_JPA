				...
				<ul class="list-unstyled list-inline pull-right">
					...
					<li><c:choose>
							<c:when test="${sessionScope.account == null}">
								...
								</a> | <a href="${pageContext.request.contextPath }/register">Register</a>
							</c:when>
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/member/myaccount">${sessionScope.account.getFullName()}</a>
